...
public class GlobeTraffApp extends SingleFrameApplication {
    ...
    public static final int STACK_INDEPENDENT = 0;
    public static final int STACK_STATIC = 1;
    public static final int STACK_DYNAMIC = 2;
    public static final int STACK_NEW = 3;
    ...
    private int stack_model = STACK_INDEPENDENT;
    ...
    protected void initializeParameters()
    {
        ...
        setStack_depth(1000);
        setStack_model(STACK_INDEPENDENT);
